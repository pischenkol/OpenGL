...
// Unary arithmetic operators
    ...
    &
    fvec4SIMD::operator=(fvec4SIMD const
    & v) {
    this->
    Data = v.Data;
    return *this;
...
{
this->
Data = _mm_add_ps(this->Data, v.Data);
return *this;
}
...
{
this->
Data = _mm_sub_ps(this->Data, v.Data);
return *this;
}
...
{
this->
Data = _mm_mul_ps(this->Data, v.Data);
return *this;
}
...
{
this->
Data = _mm_div_ps(this->Data, v.Data);
return *this;
}
...
GLM_FUNC_QUALIFIER detail::fvec4SIMD
niceSqrt(detail::fvec4SIMD const
& x)
{
return
_mm_sqrt_ps(x
...
GLM_FUNC_QUALIFIER detail::fvec4SIMD
fastSqrt(detail::fvec4SIMD const
& x)
{
return
...
GLM_FUNC_QUALIFIER detail::fvec4SIMD
inversesqrt(detail::fvec4SIMD const
& x)
{
GLM_ALIGN(4)
...
GLM_FUNC_QUALIFIER detail::fvec4SIMD
fastInversesqrt(detail::fvec4SIMD const
& x)
{
return
_mm_rsqrt_ps(x
